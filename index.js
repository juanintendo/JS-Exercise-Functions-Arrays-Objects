 ...
 */
function temperatureInF(celsius, fahrenheit) {
  if (fahrenheit === 'F') {
  return celsius + fahrenheit;
}
 else { let c = temperatureCtoF(celsius)
